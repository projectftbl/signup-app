...
import { SIGN_ON_SUCCESS, RELOAD_SUCCESS, SIGN_OUT_SUCCESS, VERIFY_SUCCESS } from '../ducks/session';
...
export function* reload() {
  while(true) {
    const { payload } = yield take(RELOAD_SUCCESS);
