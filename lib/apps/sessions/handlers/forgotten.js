...
export class Forgotten extends Component {
  componentDidUpdate(previous) {
    const { forgotten, reset, clear, info, pushState } = this.props;
...
export default connect(state => ({ forgotten: state.forgotten }), { reset, pushState, info, resetPassword, clear })(Forgotten);
