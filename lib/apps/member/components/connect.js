...
export default class Connect extends Component {
  render() {
    const { disconnect, connectTo, connectRss, connectPage, accounts } = this.props;
    ...
    return (
      <div data-test='connect-form'>
        ...
        <Feed onConnect={connectPage} type='page' title='Connect Facebook Page URL' />
        <Icon network='twitter' onConnect={connectTo} />
        <Icon network='google' onConnect={connectTo} />
        <Feed onConnect={connectRss} type='rss' title='Connect RSS Feed' />
