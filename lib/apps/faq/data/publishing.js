...
, questions: [
  ...
  , { index: 4
    , question: 'How is new content published to Project FTBL?'
    , answer: 'Content is published through the Project FTBL publishing tool, accessible to Football Members, that allows content including text, rich text, images and video to be posted to the FTBL system for inclusion in the timelines of fans.' 
    }
  , { index: 5
    , question: 'We currently publish content to YouTube, Twitter and Facebook, do we need to publish to Project FTBL as well?'
    , answer: 'Content should be posted to FTBL simultaneously using the FTBL publishing tool. Project FTBL also has a content import engine that can extract relevant postings from, YouTube Facebook and Twitter and repost them to Project FTBL.' 
    }
  , { index: 6
