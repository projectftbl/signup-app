  ...
  return (
    <li onClick={props.onClick}>
      <Link to={props.to} style={styles.base}>
        <Ball style={{marginTop:-4, marginRight:10}} /> Project: FBTL
      </Link>
    </li>
  );
}
...
export default props => {
  ...
  return (
    <ul style={styles.base}>
      <NavigationHeader to='/members' onClick={onNavigate}/>
      <NavigationItem to='/members' onClick={onNavigate}>Members</NavigationItem>
    </ul>
  );
}